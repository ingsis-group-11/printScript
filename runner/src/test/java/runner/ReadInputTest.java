...
public class ReadInputTest {
  ...
  public void simpleNumberInput() throws IOException {
    ...
    runner.run(new FileInputStream("src/test/resources/input/simpleInput.txt"),"1.1",testInputProvider);
  ...
  public void multipleReadInput() throws IOException {
    ...
    Runner runner = new Runner();
    runner.run(new FileInputStream("src/test/resources/input/multipleReadInput.txt"),"1.1",testInputProvider);
    assertFalse(testInputProvider.hasInputsToRead());
  }
  ...
  public void assignationNumberReadInput() throws IOException {
    TestInputProvider testInputProvider = new TestInputProvider(List.of("20"));
    Runner runner = new Runner();
    runner.run(new FileInputStream("src/test/resources/input/assignationNumberReadInput.txt"),"1.1",testInputProvider);
    assertFalse(testInputProvider.hasInputsToRead());
  }
  ...
  public void assignationBooleanReadInput() throws IOException {
    ...
    Runner runner = new Runner();
    runner.run(new FileInputStream("src/test/resources/input/assignationBooleanReadInput.txt"),"1.1",testInputProvider);
    assertFalse(testInputProvider.hasInputsToRead());
  }
  ...
  public void printNumberReadInput() throws IOException {
    ...
    Runner runner = new Runner();
    runner.run(new FileInputStream("src/test/resources/input/printNumberReadInput.txt"),"1.1",testPrintProvider, testInputProvider);
    assertFalse(testInputProvider.hasInputsToRead());
