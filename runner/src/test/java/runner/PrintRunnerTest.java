...
public class PrintRunnerTest {
    ...
    @Test public void simpleNumberPrint() throws IOException {
    ...
    @Test public void simpleStringPrint() throws IOException {
        Runner runner = new Runner();
    ...
    @Test public void complexStringPrint() throws IOException {
        Runner runner = new Runner();
    ...
    @Test public void additionNumberPrint() throws IOException {
        Runner runner = new Runner();
    ...
    @Test public void subtractionNumberPrint() throws IOException {
        Runner runner = new Runner();
    ...
    @Test public void multiplicationNumberPrint() throws IOException {
        Runner runner = new Runner();
    ...
    @Test public void divisionNumberPrint() throws IOException {
        Runner runner = new Runner();
    ...
    @Test public void additionStringPrint() throws IOException {
        Runner runner = new Runner();
    ...
    @Test public void subtractionStringPrint() {
        Runner runner = new Runner();
